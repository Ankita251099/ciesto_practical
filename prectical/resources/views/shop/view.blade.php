...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="row pb-2">
      ...
      <div class="col-12">   
       <a href="{{asset('uploads/download/shop_csv.xls')}}" download style="float: right;" class="btn btn-success "> Download</a>
        <button  data-toggle="modal" data-target="#exampleModal" style="float: right;" class="btn btn-danger "> Import</button>
        <a href="#"  type="button" style="float: right;" class="btn btn-warning "> Export</a>

        <a href="{{route('shop.create')}}" type="button" style="float: right;" class="btn btn-primary "> Add Shop</a>
      </div>
    </div>
